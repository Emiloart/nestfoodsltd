...
const trustItems = [
  {
    ...
    description: "Licensed bread production with a cleaner public trust signal.",
  },
  {
    title: "Hygienic Standards",
    description: "Clean workflow, QA control, and packaging discipline.",
  },
  {
    title: "Reliable Supply",
    description: "Regional readiness stays clear for retail and partner supply.",
  },
  {
    title: "Quality Ingredients",
    description: "Ingredient clarity supports confidence in every bread line.",
  },
];
