...
export const CMS_SEED_DATA: CmsData = {
  pages: {
    home: {
      ...
      heroMediaKind: "image",
      heroImageUrl: "/media/hero/nestfoodsltd-desktop-hero-banner2.png",
      heroImageMobileUrl: "/media/hero/nestfoodsltd-mobile-hero-image.png",
      heroVideoPosterUrl: "/media/hero/nestfoodsltd-desktop-hero-banner2.png",
      ...
      seo: {
        ...
        ogImageUrl: "/media/hero/nestfoodsltd-desktop-hero-banner2.png",
      },
      updatedAt: now,
      revisions: [],
    },
  ...
  media: [
    ...
    },
    {
      ...
      label: "Hero Image",
      kind: "image",
      url: "/media/hero/nestfoodsltd-desktop-hero-banner2.png",
